...
void Sandbox2D::OnUpdate(Hazel::Timestep ts)
{
	...
	
	{
		...
		Hazel::Renderer2D::DrawRotateQuad({ 0.0f, 0.0f, 0.1f }, { 1.0f, 1.0f }, glm::radians(rotation), m_CheckerboardTexture,  20.0f, { 1.0f,1.0f,1.0f,0.5f });
	...
	if (Hazel::Input::IsMouseButtonPressed(HZ_MOUSE_BUTTON_LEFT))
	{
		...
		m_Particle.ColorBegin = { 1.0f,0.0f,0.0f,0.3f };
		m_Particle.ColorEnd = { 0.0f,0.0f,1.0f,0.8f };
